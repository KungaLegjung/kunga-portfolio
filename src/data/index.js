...
export const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'SpringBoot',     logo: D('springboot', 'original') },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'AWS(Basic)',         logo: D('amazonwebservices', 'original') },
...
export const PROJECTS = [
  ...
  },
  {
    ...
    type: 'AI · Full Stack',
    desc: 'Full-stack AI platform that audits resumes against modern recruitment standards, delivering a detailed score out of 100 using Llama 3.3-70B. Features PDF parsing, keyword extraction, and persistent scan history.',
    tech: ['React 19', 'Node.js', 'MongoDB', 'Llama 3.3', 'Groq API', 'Clerk'],
    color: '#3B82F6',
    img: neoscanImg,
    github: 'https://github.com/KungaLegjung/NeoScan.git',
